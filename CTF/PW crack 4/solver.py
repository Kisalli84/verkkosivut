...
def level_4_pw_check(correct_hash):
    pos_pw_list = [
        ...
        "b03e", "1b36", "81ff", "77e4", "dbe6", "59d9", "fd6a", "5653", "8b95", "d0e5"
    ]
    for pos_pw in pos_pw_list:
        user_pw_hash_guess = hash_pw(pos_pw)
        if user_pw_hash_guess == correct_hash:
            print("Password found:", pos_pw)
...
if __name__ == "__main__":
    level_4_pw_check(correct_pw_hash)
